...
#define PROBING_MARGIN 20  // MRiscoC Avoid clips on borders (new config suggests 0 but dunno if thats ender of aquila specific so i kept my 20) previously 20
...
#define Z_MIN_POS 0
#define X_MAX_POS 235 // Extended max to allow the probe to reach more of the bed.
...
#define FILAMENT_RUNOUT_SENSOR            // MRiscoC Enabled runout sensor support
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 14  // MRiscoC Customizable by menu
