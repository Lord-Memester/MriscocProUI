 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 60*5
#define DISABLE_IDLE_X
#define DISABLE_IDLE_Y
#define DISABLE_IDLE_Z 60*30  // Disable if the nozzle could fall onto your printed part!
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.198        // (mm) Compression length applying to all extruders
  #endif
